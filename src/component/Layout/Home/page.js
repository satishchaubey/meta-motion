...
const HomeMain = () => {
    ...
    const staticBannerData = {
        main_banner_desktop: [
            ...
            { image: '/camera.jpg', alt: 'Desktop Banner 1', link: '/', target: '_self' },
            // { image: '/wall.jpeg', alt: 'Desktop Banner 1', link: '/', target: '_self' },
        ],
        main_banner_mobile: [
    ...
    console.log(staticBannerData,"staticBannerData")
